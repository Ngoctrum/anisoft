...
export default function Support() {
  ...
  return (
    <PageAccessControl pageKey="support_enabled" pageName="Hỗ trợ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-gradient-card border-border hover:border-primary/50 transition-all">
                ...
                <CardContent>
                  <Button variant="outline" className="w-full" asChild>
                    <a
                      href={contactSettings.facebook_url || 'https://facebook.com'}
                      target="_blank"
              ...
              <Card className="bg-gradient-card border-border hover:border-primary/50 transition-all">
                ...
                <CardContent>
                  <Button variant="outline" className="w-full" asChild>
                    <a
                      href={contactSettings.youtube_url || 'https://youtube.com'}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Mở YouTube
              ...
              <Card className="bg-gradient-card border-border hover:border-primary/50 transition-all">
                ...
                <CardContent>
                  <Button variant="outline" className="w-full" asChild>
                    <a
                      href={contactSettings.contact_email ? `mailto:${contactSettings.contact_email}` : 'mailto:contact@anistudio.com'}
                    >
                      Gửi Email
                    </a>
                  </Button>
              ...
              <Card className="bg-gradient-card border-border hover:border-primary/50 transition-all">
                ...
                <CardContent>
                  <Button variant="outline" className="w-full" asChild>
                    <a
                      href={contactSettings.zalo_url || 'https://zalo.me'}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Mở Zalo
