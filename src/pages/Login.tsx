...
import { Loader2, Sparkles, ArrowLeft, User as UserIcon, Lock } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="min-h-dvh bg-[#f5f2ea] dark:bg-[#0b1210] text-foreground font-body flex items-center justify-center p-4 relative overflow-hidden">
      {/* Ambient glow */}
      <div aria-hidden className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-emerald-400/25 blur-3xl" />
      <div aria-hidden className="pointer-events-none absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-teal-400/20 blur-3xl" />
